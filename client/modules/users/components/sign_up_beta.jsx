    ...
    <form onSubmit={this.signUp.bind(this)} className="row card-panel hoverable" id="signupForm">
      ...
      <div id="socialMedia" className="card-panel hoverable">
        ...
        <h2 className="center-align">
          <a href="https://www.facebook.com/" title="Facebook"><i className="fa fa-facebook-official" /></a>
          <a href="https://twitter.com/" title="Twitter"><i className="fa fa-twitter" /></a>
          <a href="https://plus.google.com/" title="Google Plus"><i className="fa fa-google-plus-official" /></a>
          <a href="https://www.youtube.com/channel/" title="YouTube"><i className="fa fa-youtube" /></a>
        </h2>
      </div>
    </div>);
  }
