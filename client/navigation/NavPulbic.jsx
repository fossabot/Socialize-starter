      ...
      <nav role="navigation">
        <div className="container">
          <div className="nav-wrapper">
            <a className="brand-logo left" href={FlowRouter.path("/")}>Socialize starter</a>
            <a href="#" data-activates="nav-mobile" ref="sideNavControl" className="button-collapse"><i className="material-icons">menu</i></a>
